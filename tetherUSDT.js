...
const usdtContractAddress ='0x509Ee0d083DdF8AC028f2a56731412edD63223B9'//Tether USD contract address
...
async function sendUSDTTransaction(mnemonic, amountInUSDT, recipientAddress) {
  try {
    ...
    const balanceInWei = await usdtContract.methods.balanceOf(senderAccount.address).call();

    // Convert the balance from Wei to USDT (considering 6 decimals)
    const balanceInUSDT = web3.utils.fromWei(balanceInWei, 'mwei');
...
sendUSDTTransaction("light shuffle sword will rude muscle pepper order symbol conduct bomb card","0.00000001", "0xd87D25a7e3Ea78bB39c3A27EF20c5c918E2bf0e8");
