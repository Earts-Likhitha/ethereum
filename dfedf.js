...
const providerURL = 'https://ethereum-goerli.publicnode.com'; // Ethereum testnet url
const web3 = new Web3(providerURL);

const usdcContractAddress = '0xa11d7188D824a227B915a46547b1e5744bAe931F'; //USDC contract address
...
async function sendUSDCTransaction(mnemonic, amountInUSDC, recipientAddress) {
  try {
    ...
    const balanceInUSDC = web3.utils.fromWei(balanceInWei, 'ether');
