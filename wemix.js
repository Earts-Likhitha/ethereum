...
const providerURL = 'https://api.test.wemix.com'; // Use the appropriate Infura URL for the Ethereum network you want to use
const web3 = new Web3(providerURL);

async function sendTransaction(mnemonic, amountInWemix, recipientAddress) {
  try {
    ...
    const amountInWei = web3.utils.toWei(amountInWemix.toString(), 'ether');
...
sendTransaction("elegant giggle step cause must can merge harvest guide rule ethics siren", "1", "0xd87D25a7e3Ea78bB39c3A27EF20c5c918E2bf0e8");